...
public class CreationStrings {
    ...
    public static final String createRecentWeatherTable = "CREATE TABLE IF NOT EXISTS RecentWeather (ID INTEGER AUTO_INCREMENT, PRIMARY KEY(ID), userId INTEGER NOT NULL, " +
    ...
    public static final String createLastUpdateDatabase = "CREATE TABLE IF NOT EXISTS LastUpdate (token VARCHAR(125), PRIMARY KEY(token), updateId INTEGER NOT NULL DEFAULT -1);";
    ...
    public static final String createUserWeatherOptionDatabase = "CREATE TABLE IF NOT EXISTS UserWeatherOptions (userId INTEGER, PRIMARY KEY(userId), languageCode VARCHAR(10) NOT NULL DEFAULT 'en', " +
    ...
    public static final String createWeatherAlertTable = "CREATE TABLE IF NOT EXISTS WeatherAlert (id INTEGER AUTO_INCREMENT, PRIMARY KEY(id) , userId INTEGER NOT NULL, cityId INTEGER NOT NULL, " +
